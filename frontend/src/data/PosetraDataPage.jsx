export const productsData = ["Salt", "Fries", "Medicines", "Equipment", "Haneya", "DMAG", "Hanelytics", "Curatum", "Posetra", "Chocolates" ]
export const solutionsData = ["Industry","Use Case"]
export const pricingData = ["List Price","Discounts","Promotional Price","Rebates","BOGO","Customer Segmentation","Tiered Pricing","CSW (Custom Spend Waterfall)","Trade Prices"]
export const InventoryData =["Planned Inventory","Safety Stock","Consigned Inventory","Transit Inventory","Field Inventory","Intercompany Transfers","Returns","Stock Transfers"]
export const QuotationData = ["Price","Discounts","Validity Period","Status"]
export const OrderData = ["Line Items","Prices","Discounts","Upsell / Cross Sell","Validity Period","Status"]
export const ShipData = ["shipping","Transportation","Bulk","LTL","Customer Pickup","Shipment Cost"]
export const InvoiceData = ["Payment Terms","Taxes","Collections","Days of Outstanding"]
export const DashboardsData = ["My Account","My Address","My Orders","Open Orders","Shipped Orders","Track Orders","Returns","Refunds", "Logout"]
...
const salts = [
    {
        ...
        brand: "Morton",
        price: "$2.89",
        description: "A pure, all-natural, granulated salt that's designed for food canning and preservation.",
        weight: "4 lb",
        stock: 68,
        expirationDate: "2025-12-31",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1727197298/Pickle_Salt_esyftj.webp"
    },
    {
        productId: "SALT002",
        ...
        brand: "Morton",
        price: "$3.89",
        description: "An all-purpose salt that can be used for cooking, baking, and seasoning.",
        weight: "26 oz",
        stock: 86,
        expirationDate: "2025-12-31",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1727203126/Iodized_salt_f0nq9t.webp"
    },
    {
        productId: "SALT003",
        ...
        stock: 100,
        expirationDate: "2025-12-31",
image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729187823/mortan_table_salt_lt4dg8.webp"    },
    {
        productId: "SALT004",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729188380/sea_salt_uiamum.webp"    },
    {
        productId: "SALT005",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729188380/kosher_salt_h01ti6.webp"
    },
    {
        productId: "SALT006",
     ...
     image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729188533/pink_salt_oyiagd.webp"
    },
    {
        productId: "SALT0099",
        productName: "Morton Iodized Salt",
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729188533/low_sodium_salt_rqyyeu.jpg"
    },
    {
        productId: "SALT007",
       ...
       image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189044/smoke_salt_vibie9.jpg"
    },
    {
        productId: "SALT008",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189043/rock_salt_rqx9kh.jpg"    },
    {
        productId: "SALT009",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189043/pickle_salt_nkw0nw.jpg"    },
    {
        productId: "SALT010",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189042/popcorn_salt_q2yv4j.jpg"    
    },
    {
        productId: "SALT011",
    ...
    },
    {
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189712/flake_salt_gj7cut.jpg"
    },
    {
        productId: "SALT013",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189711/fleur_xsut1n.jpg"
    },
    {
        productId: "SALT014",
        ...
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189710/garlic_salt_wrfs8g.jpg"
    },
    {
        productId: "SALT015",
        ...
        stock: 90,
        expirationDate: "2025-08-15",
image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729189709/onion_salt_kg3ts5.jpg"    },
  ];
...
const medicines= [
    {
        ...
        stock: 90,
        expirationDate: "2025-08-15",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1727211295/Advil_vdvmdx.jpg"
    }
];
...
const fries= [
    {
        ...
        weight: "2 lb",
        price:"$12", 
        description: "Fast-food spot serving a menu of halal burgers, sandwiches and fries, plus desserts.",
        Dosage:"2omg",
        stock: 90,
        expirationDate: "2025-08-15",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729196336/fries_os1rib.webp"
    }
];
...
const chocolates = [
    {
        ...
        weight: "5.3 oz",
        price: "$10",
        description: "A spherical chocolate treat with a crisp wafer shell, creamy hazelnut filling, and a whole hazelnut center, wrapped in golden foil.",
        dosage: "N/A",
        stock: 100,
        expirationDate: "2025-12-31",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729225005/choc_1_onqmpn.webp"
    },
    {
        productId: "CHC002",
        productName: "Lindor",
        ...
        weight: "3.5 oz",
        price: "$7",
        description: "Premium Swiss chocolate available in various varieties such as milk, dark, and white chocolate, known for its smooth and rich texture.",
        dosage: "N/A",
        stock: 150,
        expirationDate: "2026-01-15",
        image: "https://res.cloudinary.com/dppznstlh/image/upload/v1729225004/lindor_mlcxgc.webp"
    }
];
...
export const categories = {salts, medicines, fries, curatum, hanelytics, dmag, haneya, posetra, chocolates}
